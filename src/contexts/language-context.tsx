...
const translations = {
	...
	pt: {
		...
		"login.description.otp": "Digite o código que enviamos para o seu e-mail",
		...
		"signup.description": "Complete o formulário para começar",
		"signup.firstName.label": "Nome",
		"signup.firstName.placeholder": "João",
		...
		"signup.success.message":
			"Enviamos um código de 6 dígitos para o seu e-mail. Digite-o abaixo para verificar sua conta.",
		...
		"verify.success.ready":
			"Sua conta está pronta para usar. Agora você pode acessar todas as funcionalidades da plataforma.",
		"verify.success.button": "Ir para o login",
		...
		"verify.default.message":
			"A verificação de e-mail é feita através de um código OTP enviado para o seu e-mail durante o cadastro. Entre para continuar.",
		"verify.default.backToLogin": "Voltar ao login",

		// Account page
		"account.noSession.title": "Sessão não encontrada",
		"account.noSession.description":
			"Nenhuma sessão ativa foi encontrada neste ambiente",
		"account.noSession.previewNote":
			"Se você veio de uma pré-visualização, certifique-se de ter entrado no mesmo domínio para compartilhar o cookie.",
		...
		"account.security.scopeDev":
			"Todas as aplicações sob *.janovix.workers.dev",
		"account.security.scopeProd": "Apenas aplicações sob o domínio atual",
		"account.security.note": "Nota importante",
		"account.security.noteText":
